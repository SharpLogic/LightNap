...
describe('ApiResponseComponent', () => {
  ...
  it('should wrap successful response in SuccessApiResponse', (done) => {
  ...
  it('should handle error response with errorMessages', (done) => {
    const errorResponse = new ErrorApiResponse(['Error 1', 'Error 2']);
    fixture.componentRef.setInput('apiResponse', throwError(() => errorResponse));
    fixture.detectChanges();
  ...
  it('should handle error without type property', (done) => {
    const rawError = new Error('Raw error message');
    fixture.componentRef.setInput('apiResponse', throwError(() => rawError));
    fixture.detectChanges();
  ...
  it('should handle error with type but no errorMessages', (done) => {
    const errorWithoutMessages = { type: 'Error', errorMessages: [] };
    fixture.componentRef.setInput('apiResponse', throwError(() => errorWithoutMessages));
    fixture.detectChanges();
  ...
  it('should handle null result in success response', (done) => {
  ...
  it('should handle undefined result in success response', (done) => {
  ...
  it('should handle string data in success response', (done) => {
