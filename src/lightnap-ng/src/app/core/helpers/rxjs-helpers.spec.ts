...
describe('RxJsHelpers', () => {
  describe('distinctUntilJsonChanged', () => {
    it('should emit when JSON representation changes', (done) => {
      const values: any[] = [];
      const source$ = of(
        { id: 1, name: 'John' },
        { id: 1, name: 'John' }, // Duplicate - should be filtered
        { id: 2, name: 'Jane' }, // Different - should emit
      );
    ...
    it('should emit first value even if null', (done) => {
      const values: any[] = [];
    ...
    it('should detect changes in nested objects', (done) => {
      const values: any[] = [];
      const source$ = of(
        { user: { id: 1, profile: { name: 'John' } } },
        { user: { id: 1, profile: { name: 'John' } } }, // Duplicate
        { user: { id: 1, profile: { name: 'Jane' } } }, // Changed nested value
      );
    ...
    it('should detect changes in array order', (done) => {
      const values: any[] = [];
