...
describe("NewPasswordComponent", () => {
    ...
    beforeEach(async () => {
        mockIdentityService = {
            newPassword: vi.fn().mockReturnValue(of({
    ...
    describe("New Password Flow", () => {
        it("should call identityService.newPassword on form submit with valid data", () => {
            ...
            expect(mockIdentityService.newPassword).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it("should redirect logged in user on AccessToken success", () => {
            mockIdentityService.newPassword.mockReturnValue(of({
                type: LoginSuccessType.AccessToken,
                accessToken: "test-token",
            }));
