...
import { Claim, RoleNames } from "@identity/models";
import { RouteAliasService } from "@routing";
import { map, take } from "rxjs";
import { IdentityService } from "src/app/identity/services/identity.service";

export function permissionsGuard(roles: RoleNames | Array<RoleNames>, claims: Claim | Array<Claim>, guardOptions?: { redirectTo?: Array<object> }) {
