...
public static class ApplicationServiceExtensions
{
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddApplicationServices(ILogger? logger = null)
        {
        ...
        public IServiceCollection AddDatabaseServices(IConfiguration configuration, DatabaseSettings databaseSettings, ILogger? logger = null)
        {
        ...
        public IServiceCollection AddEmailServices(EmailSettings emailSettings, ILogger? logger = null)
        {
        ...
        /// <param name="logger">An optional logger used to report what was wired up.</param>
        /// <returns>The updated service collection.</returns>
        public IServiceCollection AddIdentityServices(JwtSettings jwtSettings, WebApiAuthenticationSettings authSettings, ILogger? logger = null)
        {
        ...
        /// <param name="logger">An optional logger used to report what was wired up.</param>
        /// <returns>The updated service collection.</returns>
        public IServiceCollection AddRateLimitingServices(RateLimitingSettings rateLimitingSettings, ILogger? logger = null)
        {
        ...
        public IServiceCollection AddSwaggerServices(ILogger? logger = null)
        {
        ...
        /// </summary>
        public IServiceCollection AddLightNapTelemetryServices(bool enabled, ILogger? logger = null)
        {
            if (enabled)
            {
